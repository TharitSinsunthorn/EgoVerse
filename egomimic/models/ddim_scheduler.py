...
class DDIMScheduler:
    ...
    def step_mcmc(
        ...
        # 5 Add noise
        noise = torch.randn(pred_original_sample.shape).to(pred_original_sample)
        noisy_new_sample = self.add_noise(pred_original_sample, noise, t)  # torch

        return noisy_new_sample  # DDIMSchedulerOutput(prev_sample=noisy_new_sample, pred_original_sample=pred_original_sample)
