...
EXTRINSICS = {
    ...
    # YAM bimanual setup, calibrated 2026-04-08.
    # Scene (front) D405 → left arm base, and derived right arm base transform.
    # Source: egomimic/robot/yam/calibration/calibration_results.json
    "yamApr2026": {
        "left": np.array(
            [
                [-0.0085255075, -0.7791872576, 0.6267332234, 0.0112130205],
                [-0.9977820236, -0.0347498373, -0.0567757177, -0.2389491505],
                [0.0660177934, -0.6258271857, -0.7771627787, 0.4376352577],
                [0.0, 0.0, 0.0, 1.0],
            ]
        ),
        "right": np.array(
            [
                [-0.0171354839, -0.7675042258, 0.6408148240, 0.0003481534],
                [-0.9961306378, -0.0421487847, -0.0771183015, -0.8008019364],
                [0.0861981883, -0.6396567387, -0.7638122341, 0.4431272901],
                [0.0, 0.0, 0.0, 1.0],
            ]
        ),
    },
